...
const ServicesHero = () => (
    <section
        className='relative overflow-hidden py-40 px-10 max-sm:px-4'
        style={{ background: "linear-gradient(0deg, rgba(0,0,0, 0.6) 15%, rgb(202, 202, 202) 100%)" }}
    >
        ...
        <div className='relative z-10 max-w-6xl mx-auto flex flex-col gap-8'>
            <p className='bg-black/90 text-white py-2 px-5 rounded-full w-fit flex items-center gap-2 text-sm shadow-black shadow-2xl'>
            ...
            <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-8'>
                <div className='flex flex-col gap-5'>
                    <h1 className='text-6xl max-sm:text-4xl font-semibold leading-tight text-black/95'>
                        What I Can <br />
                        <span className='text-black/80'>Do For You</span>
                    </h1>
